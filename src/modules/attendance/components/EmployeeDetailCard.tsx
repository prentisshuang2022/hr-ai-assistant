...
import { Send, ChevronUp, ChevronDown, Sparkles, DoorOpen } from "lucide-react";
...
import type { HeatmapEmployee, DayCell, DayStatus } from "@/modules/attendance/mocks/attendance";
...
function DayRow({ day }: { day: DayCell; employee: HeatmapEmployee; onViewAccess: (d: DayCell) => void }) {
